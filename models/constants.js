/**
 ...
 IndieCade web app
 - I would like this app to output as Excel-compatible CSV data or actual spreadsheet, whatever is easier
 - Please provide a unique URL for each team (or let me create one), with that URL included as a field in the spreadsheet, so I can contact teams off this.
 - Everything listed is a required field. I’ll be adding “None” or “None of the above” as necessary.
 - I would like either a web dashboard or just an initial field in team pages that I can set to whether they’re complete or not. If a web dashboard, I would like to be able to set these criteria:
 - Incomplete
 - Ready to submit
 - Submitted

 Unique URL
 (The URL that students will use to access their team’s competition info page)
 ...
 - Our game has been uploaded to the Game Gallery but not yet approved
 - Our game has been uploaded to the Game Gallery and is approved
 - I will contact Ellen about our game’s download location
 DigiPen Game Gallery url: _______________
 Download File Size (MB): __________________​


 Team Contact Info
 Team primary contact name: ________
 Team primary contact email: ___________
 Team primary contact phone number: __________
 Team technical contact name: ___________
 Team technical contact email: ___________
 Team technical contact phone number: ___________


 Team roster
 - Name and role, divided by semicolons or line breaks

 Team additional info
 Is anyone on your team:
 - A member of a minority, underserved or underrepresented racial or ethnic group in your region of residence
 - A woman (including transgender)
 - Disabled
 - LGBT
 - None of the above

 Social Media
 Not required, but list if you have this available for your team
 - Twitter: ___________
 - Facebook: ___________
 - Team website: ____________
 - None of the above
